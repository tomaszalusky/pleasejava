...
public class TypeDependencyGraphTest {
	...
	@Test public void alltypes() {t("echo","a_test_package.ibt1","a_test_package.rec2","a_test_package.var1",
			...
			"boolean",
			"integer","a_test_package.ibt4",
			"number(30)",
			"binary_integer","a_test_package.var3","a_test_package.ibt2","a_test_package.nst1",
			"a_test_package.ibt5","a_test_package.var5",
			"pls_integer","a_test_package.ibt3","a_test_package.var2","a_test_package.nst5",
			"varchar2(200)","a_test_package.clob"
			);}
